    ...
    <div className='mt-20 mb-10'>
        <form action="" className=''>
            ...
            <div className='flex gap-3 pt-7 items-center'>
              ...
              <input type="text" placeholder=' First Name' className='md:w-70 h-7 w-40 text-purple-950 bg-purple-100 p-5 rounded-md font-space pl-3' />
                </div>
                <div className='flex flex-col'>
                    <label htmlFor="" className='text-[17px] font-normal font-space text-purple-950'>Surname</label>
              <input type="text" placeholder='Surname' className='md:w-70 h-7 w-40 text-purple-950 bg-purple-100 p-5 rounded-md font-space pl-3' />
                </div>
              </div>
              <div className='flex flex-col mt-3'>
                <label htmlFor="" className='text-[17px] font-normal font-space text-purple-950'>Email</label>
              <input type="Email" placeholder='you@example.com' required className='md:w-143 w-90 h-7 text-purple-950 bg-purple-100 p-5 rounded-md font-space' />
              </div>
              <div className='flex flex-col items-start mt-3'>
                <label htmlFor="" className='text-[17px] font-normal font-space text-purple-950'>Phone number</label>
              <input type="number" placeholder='+123 - 456 7890 123' required className='md:w-143 w-90 h-7 text-purple-950 bg-purple-100 p-5 rounded-md font-space' />
              </div>
              <div className='flex flex-col mt-3'>
                <label htmlFor="" className='text-[17px] font-normal font-space text-purple-950'>Message</label>
                <textarea name="Message" id="feedback" placeholder='Enter your message' className='md:w-143 w-90 h-50 bg-purple-100 rounded-md font-space mt-1 pl-3'></textarea>
              </div>
              ...
              <Button name='Send Message' style={"bg-purple-950 text-purple-500 text-center md:w-143 w-40 mt-5 rounded-lg hover:bg-purple-500 hover:text-purple-950 p-3 font-semibold"}/>
            </div>
        </form>
    </div>
  )
